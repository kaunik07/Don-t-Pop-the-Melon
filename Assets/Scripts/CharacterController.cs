...
public class CharacterController : MonoBehaviour
{
    ...
    private int lives;
    private DontPopTheMelon.game_states gameState;
    ...
    void Start()
    {
        gameState = DontPopTheMelon.game_states.game_in_progress;
    ...
    private void Update()
    {
        if(gameState == DontPopTheMelon.game_states.game_paused)
        {
            Time.timeScale = 0;
        }

        if(gameState == DontPopTheMelon.game_states.game_in_progress)
        {
            ...
            {
                rigidBody.linearVelocity = new Vector2(rigidBody.linearVelocity.x, Mathf.Clamp(rigidBody.linearVelocity.y, -wallSlideSpeed, float.MaxValue));
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            gameState = DontPopTheMelon.game_states.game_won;
            StopMovement();
    ...
    private void KillPlayerIfOnDeadlySurface()
    {
        ...
        if (isOnDeadlySurface && !isRespawning)
        {
            ...
            {
                gameState = DontPopTheMelon.game_states.game_over;
    ...
    IEnumerator Die()
    {
        ...
        //Stop movement
        rigidBody.constraints = RigidbodyConstraints2D.FreezeAll;
        gameState = DontPopTheMelon.game_states.respawning;
        isRespawning = true;
        lives--;
    ...
    public void SetGameState(DontPopTheMelon.game_states gameState)
    {
    ...
    public DontPopTheMelon.game_states getGameState()
    {
        return gameState;
    }
